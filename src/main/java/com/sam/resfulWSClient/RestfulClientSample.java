package com.sam.resfulWSClient;
...
public class RestfulClientSample {
	...
	private static final String URL_CREATE_CONTACT = "http://localhost:8080/prospring3/restful/contact/new";
	...
	public static void main(String[] args) {
		...
		newContact.setFirstName("Sambit5");
		newContact.setLastName("choudhury5");
